use cosmwasm_std::{DepsMut, Env, MessageInfo, Response, ensure, Addr, WasmMsg, to_json_binary, SubMsg, Reply};

use crate::error::ContractError;
use crate::msg::{InstantiateMsg, ExecMsg};
use crate::state::{Config, CONFIG, AWAITING_INITIAL_RESPS};
...
pub fn instantiate(
  ...
  -> Result<Response, ContractError> {
        ...
        msg.minimal_acceptances <=
          msg.initial_members.len() as u64,
    ...
    let msgs: Vec<_> = msg
        ...
        .map(|member| -> Result<_, ContractError> {
            ...
            let init_msg = proxy::msg::InstantiateMsg {
